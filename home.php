...
<body>
    ...
    <header class="container-fluid border shadow">
        <nav class="row container m-auto">
            <div class="col-10 d-flex align-items-center">
                <img class="roundead-circle" src="./img/rounded-circle.png" <?php echo $_SESSION['imagem'] ?> 
            ...
            <div class="col-2 d-flex align-items-center justify-content-end">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu py-0" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item py-2" href="./index.php">Sair</a>
                    </div>
                </div>
            </div>
        </nav>
    ...
    <main class="container">
        ...
        <section class="row pt-5">
            ...
            <div class="col-lg-4">
                <img class="user" style="height: 300px; width:300px" src="./img/user.png"<?php echo $_SESSION['imagem'] ?>" alt="<?php echo $_SESSION['nome'] ?>">
            </div>
